...
COMMANDTORUNCPLUSPLUS="\t\tcd /vslam/data/kitti-gray-odometry\n"
# COMMANDTORUNCPLUSPLUS+="\t\t./download_kitti_dataset.sh\n"
COMMANDTORUNCPLUSPLUS+="\t\tcd ..\n"
COMMANDTORUNCPLUSPLUS+="\t\t./vslam/ThirdParty/orbslam2/Examples/Monocular/mono_kitti /vslam/ThirdParty/orbslam2/Vocabulary/ORBvoc.txt ./KITTI00.yaml \\ \n"
COMMANDTORUNCPLUSPLUS+="\t\t\t./vslam/data/kitti-gray-odometry/sequences/00\n"
